...
| **2** | **ตัวรับรู้ (Sensors)** | ประเภทและหลักการของเซนเซอร์, คุณลักษณะ (ช่วงวัด/ความไว/ความละเอียด), สัญญาณดิจิทัล/แอนะล็อก | [Sensors](chapters/ch03-sensors/) |
| **3** | **ตัวกระทำและการเชื่อมต่อ** | LED, รีเลย์, มอเตอร์, เซอร์โว, การขับโหลดด้วยทรานซิสเตอร์/รีเลย์, การแยกกราวด์ | [Actuators](chapters/ch04-actuators/) |
| **4** | **ไมโครคอนโทรลเลอร์เบื้องต้น (ESP32/Arduino)** | สถาปัตยกรรม MCU, GPIO, โครงสร้างโปรแกรม, การจำลองด้วย Wokwi | [Microcontroller](chapters/ch05-microcontroller/) |
| **5** | **การเชื่อมต่อสัญญาณดิจิทัลและแอนะล็อก** | Digital I/O, ADC, PWM, การแปลงและปรับขนาดสัญญาณ | [I/O Interfacing](chapters/ch02-io-interfacing/) |
