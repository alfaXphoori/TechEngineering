...
<div align="center">
<svg viewBox="0 0 840 750" width="100%" height="auto" role="img" xmlns="http://www.w3.org/2000/svg">
  ...
  <defs>
    <style>
      ...
      .layer-title { font-size: 14px; font-weight: 700; fill: #ffffff; }
      .layer-sub { font-size: 11px; }
      .box-text { font-size: 11px; font-weight: 600; fill: #ffffff; }
      .flow-text { font-size: 10.5px; font-weight: 600; fill: #64748b; }
      text { font-family: 'IBM Plex Sans Thai', 'Segoe UI', sans-serif; }
    </style>
  </defs>

  <!-- ==================== ชั้นที่ 5: Application Layer ==================== -->
  <rect x="60" y="20" width="720" height="110" rx="12" fill="#10b981"/>
  <text x="90" y="46" class="layer-title">📱 ชั้นที่ 5: Application Layer</text>
  <text x="90" y="60" class="layer-sub" fill="#eafff6">แสดงผลข้อมูลแบบเรียลไทม์และระบบแจ้งเตือนภัย</text>
  
  <!-- Grafana Box -->
  <rect x="80" y="74" width="330" height="36" rx="6" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.25)"/>
  <text x="245" y="96" class="box-text" text-anchor="middle">Grafana Dashboard (วิเคราะห์แนวโน้มความสั่นสะสม)</text>
  
  <!-- Notification Box -->
  <rect x="430" y="74" width="330" height="36" rx="6" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.25)"/>
  ...
  <rect x="60" y="170" width="720" height="110" rx="12" fill="#0d9488"/>
  <text x="90" y="196" class="layer-title">☁️ ชั้นที่ 4: Processing / Cloud Layer</text>
  <text x="90" y="210" class="layer-sub" fill="#e7fbf8">จัดเก็บและประมวลผลข้อมูล Time-Series พร้อมวิเคราะห์ด้วย AI</text>
  
  <!-- MQTT & Parser Box -->
  <rect x="80" y="222" width="260" height="38" rx="6" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.25)"/>
  ...
  <!-- InfluxDB Box -->
  <rect x="390" y="218" width="370" height="20" rx="4" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.25)"/>
  <text x="575" y="232" class="box-text" text-anchor="middle" font-size="10px">Time-Series DB (InfluxDB)</text>
  
  <!-- ML Model Box -->
  <rect x="390" y="242" width="370" height="20" rx="4" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.25)"/>
  ...
  <rect x="60" y="320" width="720" height="110" rx="12" fill="#0891b2"/>
  <text x="90" y="346" class="layer-title">📶 ชั้นที่ 3: Network Layer</text>
  <text x="90" y="360" class="layer-sub" fill="#e6f7fc">เครือข่ายสื่อสารไร้สายและความปลอดภัยเกรดอุตสาหกรรม</text>
  
  <!-- Wireless AP Box -->
  <rect x="80" y="374" width="200" height="36" rx="6" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.25)"/>
  ...
  <!-- Local Router Box -->
  <rect x="310" y="374" width="200" height="36" rx="6" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.25)"/>
  ...
  <!-- Firewall Box -->
  <rect x="540" y="374" width="220" height="36" rx="6" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.25)"/>
  ...
  <rect x="60" y="470" width="720" height="110" rx="12" fill="#0e7490"/>
  <text x="90" y="496" class="layer-title">💻 ชั้นที่ 2: Edge Processing Layer</text>
  <text x="90" y="510" class="layer-sub" fill="#e6f5fa">ประมวลผลคำนวณและแปลงพารามิเตอร์สัญญาณส่วนขอบ</text>
  
  <!-- ADC Box -->
  <rect x="80" y="524" width="280" height="36" rx="6" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.25)"/>
  ...
  <!-- Gateway Box -->
  <rect x="400" y="524" width="360" height="36" rx="6" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.25)"/>
  ...
  <rect x="60" y="620" width="720" height="110" rx="12" fill="#0369a1"/>
  <text x="90" y="646" class="layer-title">🔌 ชั้นที่ 1: Perception Layer</text>
  <text x="90" y="660" class="layer-sub" fill="#e0f2fe">ติดตั้งเซนเซอร์วัดค่าทางกายภาพของเครื่องจักร</text>
  
  <!-- Accelerometer Box -->
  <rect x="80" y="674" width="330" height="36" rx="6" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.25)"/>
  <text x="245" y="696" class="box-text" text-anchor="middle">ปั๊มหอยโข่ง ➔ IEPE Accelerometer (วัดความสั่น)</text>
  
  <!-- RTD Box -->
  <rect x="430" y="674" width="330" height="36" rx="6" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.25)"/>
