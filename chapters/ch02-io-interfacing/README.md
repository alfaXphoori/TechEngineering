...
<div style="text-align: center; margin: 20px 0;">
  <img src="../../assets/images/arduino_uno.jpg" alt="Arduino Uno Board" style="max-width: 300px; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); border: 1px solid #e2e8f0;"/>
  <div style="font-size: 12px; color: #64748b; margin-top: 8px;">ภาพที่ 2.1 บอร์ดไมโครคอนโทรลเลอร์ Arduino Uno R3 สำหรับควบคุมและเชื่อมต่อสัญญาณดิจิทัล/แอนะล็อก</div>
</div>
...
<div style="font-size: 12px; color: #64748b; margin-top: 8px;">ภาพที่ 2.2 การเปรียบเทียบระหว่างสภาวะลอย (Floating) ที่สัญญาณมีคลื่นรบกวนปะปน กับสภาวะพูลอัป (Pull-Up) และพูลดาวน์ (Pull-Down) ที่มีระดับต้านทานคงที่ดึงค่าแน่นอนไว้</div>
</div>
...
<div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap; margin: 20px 0;">
  <div style="text-align: center; max-width: 200px;">
    <img src="../../assets/images/green_led.jpg" alt="Green LED" style="width: 150px; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); border: 1px solid #e2e8f0;"/>
    <div style="font-size: 11px; color: #64748b; margin-top: 6px;">ไดโอดเปล่งแสง (LED 5mm)</div>
  </div>
  <div style="text-align: center; max-width: 200px;">
    <img src="../../assets/images/tactile_switch.jpg" alt="Tactile Switch" style="width: 150px; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); border: 1px solid #e2e8f0;"/>
    <div style="font-size: 11px; color: #64748b; margin-top: 6px;">สวิตช์ปุ่มกด (Tactile Switch)</div>
  </div>
</div>
<div style="text-align: center; font-size: 12px; color: #64748b; margin-bottom: 20px;">ภาพที่ 2.3 อุปกรณ์แสดงผล LED และอุปกรณ์รับเข้าแบบปุ่มกดสำหรับใบงานและระบบลอจิกพื้นฐาน</div>
...
<div style="font-size: 12px; color: #64748b; margin-top: 8px;">ภาพที่ 2.4 กระบวนการสุ่มตัวอย่างตามคาบเวลา (Sampling at t) และการแปลงค่าความต่อเนื่องให้เป็นขั้นบันไดดิจิทัล (Quantization) ตามระดับบิต</div>
</div>
...
<div style="font-size: 12px; color: #64748b; margin-top: 8px;">ภาพที่ 2.5 อัตราส่วนความกว้างพัลส์ (Duty Cycle) ของสัญญาณ PWM ส่งผลต่อค่าแรงดันเฉลี่ยและความสว่างของหลอด LED ในลักษณะสัดส่วนเชิงเส้น</div>
</div>
...
## 2.8 การปรับขนาดสัญญาณด้วย `map()` และการ Calibrate
