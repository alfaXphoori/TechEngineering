...
### 2.1.1 หลักการทางฟิสิกส์และแบบจำลองทางคณิตศาสตร์ของเซนเซอร์แบบความต้านทาน (Resistive Sensors)
...
### 2.5.4 การกรองสัญญาณรบกวนด้วยซอฟต์แวร์ (Software Signal Filtering)
