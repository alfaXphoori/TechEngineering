...
บทนี้เชื่อมโยงกับชั้น Perception Layer ซึ่งเป็นจุดเริ่มต้นของการรับรู้ข้อมูลจากโลกจริงในระบบ IoT
...
<svg viewBox="0 0 760 450" width="100%" height="auto" role="img" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- คำบรรยายแผนภาพ -->
  <text x="380" y="432" class="footer-text" text-anchor="middle">แผนภาพที่ 2.1 สถาปัตยกรรม IoT 4 ชั้น แสดงการไหลของข้อมูลสองทิศทาง (Bi-directional Data Flow)</text>
</svg>
</div>
