...
## 3.9 อุปกรณ์เอาต์พุตและระบบขับกำลังที่ใช้งานบน Tinkercad (Tinkercad Actuators & Power Control)
...
### 3.9.1 อุปกรณ์แสดงผลและไฟแสงสว่าง (Displays & Lighting)
...
### 3.9.2 มอเตอร์และตัวขับเคลื่อนเชิงกล (Motors & Mechanical Actuators)
...
### 3.9.3 อุปกรณ์ควบคุมและวงจรขับกำลัง (Power Control & Regulators)
...
## 3.10 การคำนวณกำลังและการระบายความร้อน (Power & Thermal Considerations)
...
## 3.11 ตัวอย่างการออกแบบระบบจริง: ระบบรดน้ำอัตโนมัติ (Design Walkthrough)
