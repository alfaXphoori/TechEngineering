...
<svg viewBox="0 0 760 320" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <text x="344" y="186" class="text-code" fill="#475569">B</text>
  <text x="393" y="156" class="text-code" fill="#475569">C</text>
  <text x="393" y="234" class="text-code" fill="#475569">E</text>
