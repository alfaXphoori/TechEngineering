...
<div style="font-size: 12px; color: #64748b; margin-top: 8px;">ภาพที่ 3.1 กระแสจะไหลได้เมื่อมีแหล่งจ่ายและเส้นทางกลับครบเป็นวงจรปิด</div>
</div>
...
<div style="font-size: 12px; color: #64748b; margin-top: 8px;">ภาพที่ 3.2 วงจรอนุกรมใช้หลักการแบ่งแรงดัน ส่วนวงจรขนานใช้หลักการแบ่งกระแส</div>
</div>

วงจรแบ่งแรงดัน (Voltage Divider) ที่จะใช้กับ LDR และ Thermistor ในหัวข้อ 3.2.3 เป็นตัวอย่างสำคัญของวงจรอนุกรม: ตัวต้านทานคงที่และตัวต้านทานของเซนเซอร์ต่อเรียงกัน ทำให้แรงดันที่จุดกึ่งกลางเปลี่ยนตามค่าความต้านทานของเซนเซอร์
...
<div style="font-size: 12px; color: #64748b; margin-top: 8px;">ภาพที่ 3.3 ตัวต้านทาน pull-up ทำให้ขาอินพุตมีสถานะชัดเจน ไม่ลอย และยอมให้อุปกรณ์ดึงสายลง LOW ได้</div>
</div>

แนวคิดนี้สำคัญมากกับ GPIO, I2C และ One-Wire เพราะบัสเหล่านี้มักต้องมีสถานะว่างเป็น HIGH แล้วให้อุปกรณ์บนบัสดึงสายลง LOW เมื่อจะส่งสัญญาณ ในหัวข้อ 3.5 จะเห็นการใช้ pull-up ค่า $4.7\text{ k}\Omega$ ถึง $10\text{ k}\Omega$ กับสาย I2C และ One-Wire อยู่บ่อยครั้ง
