...
<svg viewBox="0 0 780 340" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <style>
    ...
    .noise-path { fill: none; stroke: #f59e0b; stroke-width: 2; stroke-dasharray: 4 4; animation: noiseMarch 0.8s linear infinite; }
  ...
  <circle cx="140" cy="210" r="6" fill="#cbd5e1" stroke="#334155" stroke-width="1.5"/>
  <path d="M 40 210 Q 60 190 80 210 T 120 210 T 160 210" class="noise-path"/>
  <text x="100" y="175" fill="#d97706" font-size="11" font-weight="700" text-anchor="middle">คลื่นสัญญาณรบกวน (Noise)</text>
  <rect x="75" y="240" width="120" height="40" rx="5" fill="#f1f5f9" stroke="#cbd5e1"/>
  ...
  <circle cx="390" cy="210" r="6" class="state-dot-pu"/>
  <rect x="420" y="240" width="80" height="40" rx="5" fill="#f1f5f9" stroke="#cbd5e1"/>
  ...
  <circle cx="640" cy="210" r="6" class="state-dot-pd"/>
  <rect x="670" y="240" width="80" height="40" rx="5" fill="#f1f5f9" stroke="#cbd5e1"/>
...
#### ปัญหาสัญญาณกระเด้ง (Contact Bounce) และแนวทาง Debouncing
...
<svg viewBox="0 0 780 340" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <style>
    ...
    .grid-axis { stroke: #475569; stroke-width: 2; stroke-linecap: round; }
    .analog-curve { fill: none; stroke: #2563eb; stroke-width: 3; stroke-linecap: round; }
    .quantized-stairs { fill: none; stroke: #10b981; stroke-width: 3; stroke-linejoin: round; stroke-linecap: round; }
    .sampled-dot { fill: #10b981; stroke: #ffffff; stroke-width: 1.5; }
    .text-main { font-size: 13px; font-weight: 700; fill: #1e293b; }
    .text-sub { font-size: 11px; fill: #64748b; }
    .text-code { font-size: 11px; font-family: monospace; font-weight: 700; fill: #7c3aed; }
  </style>
  ...
  <line x1="80" y1="40" x2="80" y2="300" stroke="#dc2626" stroke-width="2" stroke-dasharray="3 3">
  ...
  <rect x="520" y="15" width="220" height="65" rx="5" fill="#ffffff" stroke="#cbd5e1" opacity="0.9"/>
...
```mermaid
graph LR
    subgraph ADC_Response [กราฟการตอบสนองของ ESP32 ADC]
        A[0.0V - 0.15V] -->|Dead Zone เอาต์พุตเป็น 0| B(0)
        C[0.15V - 3.1V] -->|ช่วงทำงานที่เป็นเชิงเส้นตรงที่สุด| D(186 - 3845)
        E[3.1V - 3.3V] -->|Saturation Zone อิ่มตัวสูงสุด| F(4095)
    end
```
...
<svg viewBox="0 0 780 340" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <style>
    .bg { fill: #f8fafc; stroke: #cbd5e1; stroke-width: 1; rx: 10px; }
    .panel { fill: #ffffff; stroke: #cbd5e1; stroke-width: 1.5; rx: 8px; }
    .pwm-wave { fill: none; stroke: #2563eb; stroke-width: 3; stroke-linecap: round; stroke-linejoin: round; }
    .timeline { stroke: #cbd5e1; stroke-width: 1; stroke-dasharray: 4 4; }
    .led-off { fill: #e2e8f0; stroke: #94a3b8; stroke-width: 2; }
    .text-main { font-size: 13px; font-weight: 700; fill: #1e293b; }
    .text-sub { font-size: 11px; fill: #64748b; }
    .text-code { font-size: 11px; font-family: monospace; font-weight: 700; fill: #7c3aed; }
    
    @keyframes glow25 {
      0%, 100% { fill: #fef08a; filter: drop-shadow(0 0 2px #facc15); opacity: 0.35; }
      50% { fill: #fef08a; filter: drop-shadow(0 0 4px #facc15); opacity: 0.5; }
    }
    @keyframes glow50 {
      0%, 100% { fill: #fef08a; filter: drop-shadow(0 0 6px #facc15); opacity: 0.6; }
      50% { fill: #fde047; filter: drop-shadow(0 0 10px #facc15); opacity: 0.75; }
    }
    @keyframes glow75 {
      0%, 100% { fill: #fde047; filter: drop-shadow(0 0 12px #eab308); opacity: 0.85; }
      50% { fill: #facc15; filter: drop-shadow(0 0 20px #eab308); opacity: 1; }
    }
    
    .led-glow-25 { animation: glow25 2s ease-in-out infinite; }
    .led-glow-50 { animation: glow50 2s ease-in-out infinite; }
    .led-glow-75 { animation: glow75 2s ease-in-out infinite; }
    
    @keyframes travelWave {
      0% { stroke-dashoffset: 0; }
      100% { stroke-dashoffset: -120; }
    }
    .wave-flow { stroke-dasharray: 10 15; stroke: #f59e0b; stroke-width: 4; animation: travelWave 4s linear infinite; }
  </style>
  ...
  <g transform="translate(630, 68)">
    <circle cx="0" cy="0" r="22" class="led-off"/>
    <circle cx="0" cy="0" r="20" class="led-glow-25"/>
    <path d="M -8 8 L -15 15 M 8 8 L 15 15 M 0 10 L 0 20" stroke="#94a3b8" stroke-width="2"/>
...
<svg viewBox="0 0 780 340" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <style>
    ...
    .pwm-line { fill: none; stroke: #3b82f6; stroke-width: 3; }
    .dac-line { fill: none; stroke: #10b981; stroke-width: 3; }
    .avg-line { fill: none; stroke: #ref4444; stroke-width: 2; stroke-dasharray: 4 4; }
    .avg-line-styled { fill: none; stroke: #dc2626; stroke-width: 2; stroke-dasharray: 4 4; }
    ...
    .pwm-flow { stroke-dasharray: 8 12; stroke: #fbbf24; stroke-width: 4; stroke-linecap: round; animation: travelPWM 3s linear infinite; }
    
    @keyframes travelDAC {
      0% { stroke-dashoffset: 0; }
      100% { stroke-dashoffset: -120; }
    }
    .dac-flow { stroke-dasharray: 8 12; stroke: #f59e0b; stroke-width: 4; stroke-linecap: round; animation: travelDAC 3s linear infinite; }
  </style>
