...
## สรุปประจำบทที่ 6 (Summary)

- สรุปความแตกต่างของโปรโตคอลอนุกรม I2C, SPI, UART และการเชื่อมต่อเซนเซอร์กับหน้าจอแสดงผล

</div>

<div class="chapter-tab-content" data-tab-name="Challenge" data-tab-icon="🏆" id="challenge" markdown="1">

## แบบฝึกหัดท้ายบทที่ 6 (Exercises)

1. อธิบายข้อดีของการสื่อสารแบบ I2C เมื่อเทียบกับ SPI
2. เขียนโปรแกรมสลับการแสดงผลหน้าจอ OLED ทุกๆ 2 วินาที
</div>
