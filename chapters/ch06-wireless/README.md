...
<svg viewBox="0 0 760 480" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <style>
    .bg { fill: #f8fafc; stroke: #cbd5e1; stroke-width: 1; rx: 12px; }
    .node-box { fill: #ffffff; stroke: #1e293b; stroke-width: 2.5; rx: 8px; }
    .node-title { font-size: 14px; font-weight: 700; fill: #0f172a; text-anchor: middle; }
    .node-subtitle { font-size: 12px; fill: #64748b; text-anchor: middle; }
    .lifeline { stroke: #94a3b8; stroke-width: 2; stroke-dasharray: 6 4; }
    .arrow-line { stroke: #334155; stroke-width: 2; stroke-linecap: round; }
    .arrow-head { fill: #334155; }
    .packet-glow { fill: none; stroke: #06b6d4; stroke-width: 4; stroke-linecap: round; stroke-dasharray: 12 100; stroke-dashoffset: 0; }
    .packet-glow-rev { fill: none; stroke: #3b82f6; stroke-width: 4; stroke-linecap: round; stroke-dasharray: 12 100; stroke-dashoffset: 0; }
    .packet-glow-both { fill: none; stroke: #10b981; stroke-width: 4; stroke-linecap: round; stroke-dasharray: 12 100; stroke-dashoffset: 0; }
    
    .anim-r1 { animation: walkRight 3s infinite linear; }
    .anim-l1 { animation: walkLeft 3s infinite linear; animation-delay: 0.5s; }
    .anim-r2 { animation: walkRight 3s infinite linear; animation-delay: 1s; }
    .anim-l2 { animation: walkLeft 3s infinite linear; animation-delay: 1.5s; }
    .anim-r3 { animation: walkRight 3s infinite linear; animation-delay: 2s; }
    .anim-l3 { animation: walkLeft 3s infinite linear; animation-delay: 2.2s; }
    .anim-both { animation: walkBoth 2s infinite linear; }
    ...
    .msg-num { font-size: 11px; fill: #ffffff; font-weight: bold; }
    .num-circle { fill: #1e293b; }
    .phase-tag { fill: #f1f5f9; stroke: #e2e8f0; rx: 4px; }
    .phase-text { font-size: 11px; fill: #64748b; font-weight: bold; }
  </style>
  ...
  <rect x="25" y="115" width="95" height="75" class="phase-tag" />
  ...
  <rect x="25" y="205" width="95" height="50" class="phase-tag" />
  ...
  <rect x="25" y="270" width="95" height="50" class="phase-tag" />
  ...
  <rect x="25" y="335" width="95" height="75" class="phase-tag" style="fill: #ecfdf5; stroke: #a7f3d0;" />
  <text x="72" y="365" class="phase-text" text-anchor="middle" style="fill: #065f46;">4. เข้ารหัสลับ</text>
  <text x="72" y="382" class="phase-text" text-anchor="middle" style="fill: #065f46;">(4-Way Handshake)</text>
  ...
  <!-- Client Node Header -->
  <rect x="130" y="30" width="140" height="60" class="node-box" style="stroke: #0284c7; fill: #f0f9ff;"/>
  <text x="200" y="55" class="node-title" style="fill: #0369a1;">ลูกข่าย Wi-Fi</text>
  <text x="200" y="75" class="node-subtitle" style="fill: #0284c7;">(ESP32 Station)</text>

  <!-- AP Node Header -->
  <rect x="490" y="30" width="140" height="60" class="node-box" style="stroke: #4f46e5; fill: #e0e7ff;"/>
  <text x="560" y="55" class="node-title" style="fill: #3730a3;">จุดเข้าใช้งาน</text>
  <text x="560" y="75" class="node-subtitle" style="fill: #4f46e5;">(Access Point - AP)</text>
  ...
  <g>
    ...
    <path d="M 200 130 L 560 130" class="packet-glow anim-r1" />
    <circle cx="165" cy="130" r="10" class="num-circle" />
    <text x="165" y="134" class="msg-num" text-anchor="middle">1</text>
    <text x="380" y="122" class="msg-text" text-anchor="middle">Probe Request (ค้นหาสัญญาณ)</text>
  </g>
  ...
  <g>
    ...
    <path d="M 560 170 L 200 170" class="packet-glow-rev anim-l1" />
    <circle cx="595" cy="170" r="10" class="num-circle" />
    <text x="595" y="174" class="msg-num" text-anchor="middle">2</text>
    <text x="380" y="162" class="msg-text" text-anchor="middle">Probe Response (ตอบกลับความพร้อม)</text>
  </g>
  ...
  <g>
    ...
    <path d="M 200 220 L 560 220" class="packet-glow anim-r2" />
    <circle cx="165" cy="220" r="10" class="num-circle" />
    <text x="165" y="224" class="msg-num" text-anchor="middle">3</text>
    <text x="380" y="212" class="msg-text" text-anchor="middle">Authentication Request (ส่งคำขอพิสูจน์สิทธิ์)</text>
  </g>
  ...
  <g>
    ...
    <path d="M 560 250 L 200 250" class="packet-glow-rev anim-l2" />
    <circle cx="595" cy="250" r="10" class="num-circle" />
    <text x="595" y="254" class="msg-num" text-anchor="middle">4</text>
    <text x="380" y="242" class="msg-text" text-anchor="middle">Authentication Response (ยืนยันสิทธิ์เบื้องต้น)</text>
  </g>
  ...
  <g>
    ...
    <path d="M 200 285 L 560 285" class="packet-glow anim-r3" />
    <circle cx="165" cy="285" r="10" class="num-circle" />
    <text x="165" y="289" class="msg-num" text-anchor="middle">5</text>
    <text x="380" y="277" class="msg-text" text-anchor="middle">Association Request (ขอเชื่อมต่อลิงก์ข้อมูล)</text>
  </g>
  ...
  <g>
    ...
    <path d="M 560 315 L 200 315" class="packet-glow-rev anim-l3" />
    <circle cx="595" cy="315" r="10" class="num-circle" />
    <text x="595" y="319" class="msg-num" text-anchor="middle">6</text>
    <text x="380" y="307" class="msg-text" text-anchor="middle">Association Response (ตอบกลับการยอมรับลิงก์)</text>
  </g>

  <!-- Step 7: 4-Way WPA Handshake (Exchanging Keys) -->
  <g>
    <rect x="180" y="340" width="400" height="70" rx="8" fill="#e8f5e9" stroke="#c8e6c9" stroke-width="1"/>
    <line x1="210" y1="360" x2="550" y2="360" class="arrow-line" style="stroke: #2e7d32;" />
    <polygon points="215,356 205,360 215,364" fill="#2e7d32" />
    <polygon points="545,356 555,360 545,364" fill="#2e7d32" />
    <line x1="210" y1="390" x2="550" y2="390" class="arrow-line" style="stroke: #2e7d32;" />
    <polygon points="215,386 205,390 215,394" fill="#2e7d32" />
    <polygon points="545,386 555,390 545,394" fill="#2e7d32" />
    <g transform="translate(370, 363)">
      <rect x="2" y="7" width="16" height="11" rx="2" fill="#2e7d32"/>
      <path d="M 4 7 L 4 4 A 4 4 0 0 1 16 4 L 16 7" fill="none" stroke="#2e7d32" stroke-width="2"/>
    </g>
    <path d="M 200 360 L 560 360" class="packet-glow-both anim-both" />
    <path d="M 560 390 L 200 390" class="packet-glow-both anim-both" style="animation-direction: reverse;" />
    <circle cx="165" cy="375" r="10" class="num-circle" style="fill: #2e7d32;" />
    <text x="165" y="379" class="msg-num" text-anchor="middle">7</text>
    <text x="380" y="352" class="msg-text" text-anchor="middle" style="fill: #1b5e20;">กระบวนการ 4-Way Handshake (WPA2/WPA3)</text>
    <text x="380" y="405" class="msg-text" text-anchor="middle" style="fill: #2e7d32; font-size: 10px;">(แลกเปลี่ยนคีย์ PTK เข้ารหัสข้อมูลโดยไม่ส่งรหัสผ่านจริงทางวิทยุ)</text>
  </g>
</svg>
</div>
...
<svg viewBox="0 0 760 380" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <style>
    .bg { fill: #f8fafc; stroke: #cbd5e1; stroke-width: 1; rx: 12px; }
    .client-shell { fill: #f1f5f9; stroke: #64748b; stroke-width: 3; rx: 16px; }
    .client-screen { fill: #0f172a; rx: 8px; }
    .profile-box { fill: none; stroke: #64748b; stroke-dasharray: 6 4; stroke-width: 2; rx: 12px; }
    .service-box { fill: #f0f9ff; stroke: #0284c7; stroke-width: 2.5; rx: 10px; }
    .char-box { fill: #ffffff; stroke: #0f766e; stroke-width: 2; rx: 6px; }
    
    .text-title { font-size: 13px; font-weight: 700; fill: #0f172a; }
    .text-subtitle { font-size: 11px; fill: #475569; }
    .text-uuid { font-size: 10px; font-family: monospace; fill: #7c3aed; font-weight: bold; }
    .prop-pill { fill: #f0fdf4; stroke: #bbf7d0; rx: 3px; }
    .prop-text { font-size: 9.5px; fill: #15803d; font-weight: bold; }
    
    .comm-path { fill: none; stroke: #94a3b8; stroke-width: 1.5; stroke-dasharray: 4 4; }
    .pulse-dot-req { fill: #0ea5e9; r: 5; animation: pulseReq 2.5s infinite ease-in-out; }
    .pulse-dot-notif { fill: #10b981; r: 5; animation: pulseNotif 2.5s infinite ease-in-out; }

    @keyframes pulseReq {
      0% { cx: 185; cy: 190; opacity: 0; }
      10% { opacity: 1; }
      40%, 100% { cx: 330; cy: 140; opacity: 0; }
    }
    @keyframes pulseNotif {
      0%, 40% { cx: 330; cy: 160; opacity: 0; }
      50% { opacity: 1; }
      80%, 100% { cx: 185; cy: 260; opacity: 0; }
    }
  </style>
  ...
  <g id="gatt-client">
    <rect x="40" y="50" width="130" height="280" class="client-shell" />
    <rect x="48" y="70" width="114" height="230" class="client-screen" />
    <circle cx="105" cy="60" r="4" fill="#94a3b8" />
    <rect x="90" y="310" width="30" height="10" rx="5" fill="#94a3b8" />
    
    <text x="105" y="95" fill="#f8fafc" font-size="12" font-weight="bold" text-anchor="middle">GATT Client</text>
    <text x="105" y="112" fill="#38bdf8" font-size="10" text-anchor="middle">(แอปมือถือ/คอนโทรลเลอร์)</text>
    
    <rect x="57" y="150" width="96" height="40" rx="6" fill="#1e293b" stroke="#38bdf8" stroke-width="1.5" />
    <text x="105" y="166" fill="#38bdf8" font-size="10" font-weight="bold" text-anchor="middle">Read Request</text>
    <text x="105" y="180" fill="#94a3b8" font-size="9" text-anchor="middle">ส่งคำขออ่านค่า</text>
    
    <rect x="57" y="215" width="96" height="40" rx="6" fill="#1e293b" stroke="#10b981" stroke-width="1.5" />
    <text x="105" y="231" fill="#10b981" font-size="10" font-weight="bold" text-anchor="middle">Notification</text>
    <text x="105" y="245" fill="#94a3b8" font-size="9" text-anchor="middle">รับการแจ้งเตือน</text>
  </g>

  <g id="gatt-server">
    <rect x="220" y="25" width="510" height="330" class="profile-box" />
    <text x="235" y="45" class="text-title" style="fill: #475569;">BLE Profile (โครงร่างโปรไฟล์หลัก)</text>
    
    <rect x="240" y="60" width="470" height="275" class="service-box" />
    <text x="255" y="85" class="text-title" style="fill: #0369a1;">Environmental Sensing Service (บริการค่าสิ่งแวดล้อม)</text>
    <text x="255" y="100" class="text-uuid">UUID: 0x181A</text>
    
    <rect x="260" y="115" width="430" height="90" class="char-box" />
    <text x="275" y="138" class="text-title" style="fill: #0f766e;">Characteristic A: Temperature (ค่าอุณหภูมิ)</text>
    <text x="275" y="152" class="text-uuid">UUID: 0x2A6E</text>
    
    <g transform="translate(275, 162)">
      <rect x="0" y="0" width="38" height="16" class="prop-pill" />
      <text x="19" y="11" class="prop-text" text-anchor="middle">Read</text>
      <rect x="44" y="0" width="42" height="16" class="prop-pill" style="fill: #ecfdf5; stroke: #a7f3d0;" />
      <text x="65" y="11" class="prop-text" text-anchor="middle" style="fill: #047857;">Notify</text>
    </g>
    
    <rect x="520" y="125" width="155" height="70" rx="6" fill="#f8fafc" stroke="#e2e8f0" />
    <text x="530" y="142" class="text-subtitle" style="font-weight: bold; fill: #0f172a;">Value: <tspan fill="#ea580c">2850 (28.50 °C)</tspan></text>
    <text x="530" y="158" class="text-subtitle" style="font-size: 9.5px; fill: #64748b;">Descriptor: CCCD (0x2902)</text>
    <text x="530" y="172" class="text-subtitle" style="font-size: 9.5px; fill: #64748b;">(การตั้งค่าแจ้งเตือน Client)</text>

    <rect x="260" y="225" width="430" height="90" class="char-box" />
    <text x="275" y="248" class="text-title" style="fill: #0f766e;">Characteristic B: Humidity (ค่าความชื้น)</text>
    <text x="275" y="262" class="text-uuid">UUID: 0x2A6F</text>
    
    <g transform="translate(275, 272)">
      <rect x="0" y="0" width="38" height="16" class="prop-pill" />
      <text x="19" y="11" class="prop-text" text-anchor="middle">Read</text>
      <rect x="44" y="0" width="42" height="16" class="prop-pill" style="fill: #ecfdf5; stroke: #a7f3d0;" />
      <text x="65" y="11" class="prop-text" text-anchor="middle" style="fill: #047857;">Notify</text>
    ...
    <rect x="520" y="235" width="155" height="70" rx="6" fill="#f8fafc" stroke="#e2e8f0" />
    <text x="530" y="252" class="text-subtitle" style="font-weight: bold; fill: #0f172a;">Value: <tspan fill="#ea580c">6520 (65.20%)</tspan></text>
    <text x="530" y="268" class="text-subtitle" style="font-size: 9.5px; fill: #64748b;">Descriptor: User Desc</text>
    <text x="530" y="282" class="text-subtitle" style="font-size: 9.5px; fill: #64748b;">(ป้ายชื่อแอตทริบิวต์)</text>
  </g>

  <path d="M 170 170 C 220 170, 240 145, 260 145" class="comm-path" stroke="#0ea5e9" />
  <path d="M 260 160 C 240 160, 220 235, 170 235" class="comm-path" stroke="#10b981" />
  
  <circle class="pulse-dot-req" />
  <circle class="pulse-dot-notif" />
</svg>
</div>
...
<svg viewBox="0 0 760 350" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <style>
    .bg { fill: #f8fafc; stroke: #cbd5e1; stroke-width: 1; rx: 12px; }
    .node-zc { fill: #fdf2f8; stroke: #db2777; stroke-width: 2.5; rx: 8px; }
    .node-zr { fill: #e0e7ff; stroke: #4f46e5; stroke-width: 2; rx: 6px; }
    .node-zed { fill: #f0fdf4; stroke: #16a34a; stroke-width: 1.5; rx: 6px; }
    
    .link { stroke: #94a3b8; stroke-width: 2; stroke-linecap: round; }
    .link-active { stroke: #10b981; stroke-width: 2.5; stroke-linecap: round; }
    .link-broken { stroke: #ef4444; stroke-width: 2; stroke-dasharray: 4 4; stroke-linecap: round; }
    
    .label-title { font-size: 13px; font-weight: 700; fill: #0f172a; text-anchor: middle; }
    .label-sub { font-size: 10px; fill: #475569; text-anchor: middle; }
    
    .failed-router { fill: #f1f5f9; stroke: #94a3b8; stroke-width: 2; rx: 6px; animation: routerFail 10s infinite; }
    .failed-cross { stroke: #ef4444; stroke-width: 4; stroke-linecap: round; opacity: 0; animation: crossAppear 10s infinite; }
    
    .packet-trail-normal { fill: none; stroke: #f59e0b; stroke-width: 4; stroke-linecap: round; stroke-dasharray: 12 300; stroke-dashoffset: 0; animation: packetNormal 10s infinite linear; }
    .packet-trail-healed { fill: none; stroke: #ea580c; stroke-width: 4; stroke-linecap: round; stroke-dasharray: 12 600; stroke-dashoffset: 0; opacity: 0; animation: packetHealed 10s infinite linear; }
    
    .heal-link { stroke: #94a3b8; stroke-width: 2; stroke-dasharray: 6 4; animation: healLinkHighlight 10s infinite; }
    .active-link-normal { stroke: #3b82f6; stroke-width: 2; animation: linkNormalActive 10s infinite; }
    
    .status-banner { fill: #1e293b; rx: 6px; }
    .status-text { font-size: 12px; fill: #ffffff; font-weight: bold; text-anchor: middle; }
    .status-lbl-normal { opacity: 0; animation: showLblNormal 10s infinite; }
    .status-lbl-fail { opacity: 0; animation: showLblFail 10s infinite; }
    .status-lbl-heal { opacity: 0; animation: showLblHeal 10s infinite; }

    @keyframes routerFail {
      0%, 39% { fill: #e0e7ff; stroke: #4f46e5; }
      40%, 89% { fill: #fee2e2; stroke: #ef4444; }
      90%, 100% { fill: #e0e7ff; stroke: #4f46e5; }
    }
    ...
    @keyframes packetNormal {
      ...
      5% { opacity: 1; }
      25% { stroke-dashoffset: -200; opacity: 1; }
      26%, 100% { stroke-dashoffset: -200; opacity: 0; }
    }
    @keyframes packetHealed {
      0%, 49% { stroke-dashoffset: 0; opacity: 0; }
      50% { opacity: 1; }
      80% { stroke-dashoffset: -460; opacity: 1; }
      81%, 100% { stroke-dashoffset: -460; opacity: 0; }
    }
    @keyframes healLinkHighlight {
      0%, 39% { stroke: #94a3b8; stroke-width: 1.5; stroke-dasharray: 6 4; }
      40%, 89% { stroke: #ea580c; stroke-width: 3; stroke-dasharray: none; }
      90%, 100% { stroke: #94a3b8; stroke-width: 1.5; stroke-dasharray: 6 4; }
    }
    @keyframes linkNormalActive {
      0%, 39% { stroke: #3b82f6; stroke-width: 2.5; }
  ...
  <line x1="380" y1="60" x2="220" y2="160" class="link" style="stroke: #3b82f6;" />
  ...
  <g transform="translate(320, 35)">
    ...
    <text x="60" y="24" class="label-title" style="fill: #9d174d;">Coordinator (ZC)</text>
    <text x="60" y="38" class="label-sub" style="fill: #db2777; font-weight: bold;">ผู้ประสานงานหลัก (ZC)</text>
  </g>

  <g transform="translate(170, 140)">
    <rect x="0" y="0" width="100" height="40" class="node-zr" />
    <text x="50" y="20" class="label-title">Router (ZR1)</text>
    <text x="50" y="32" class="label-sub">ตัวส่งต่อข้อมูล</text>
  </g>
  ...
  <g transform="translate(330, 140)">
    ...
    <text x="50" y="32" class="label-sub">ตัวส่งต่อข้อมูล</text>
    <line x1="10" y1="10" x2="90" y2="30" class="failed-cross" />
    <line x1="90" y1="10" x2="10" y2="30" class="failed-cross" />
  </g>
  ...
  <g transform="translate(95, 245)">
    ...
    <text x="45" y="27" class="label-sub" style="font-size: 9px;">ZED1</text>
  </g>

  <g transform="translate(215, 245)">
    <rect x="0" y="0" width="90" height="35" class="node-zed" />
    <text x="45" y="17" class="label-title" style="font-size: 11px;">End Device</text>
    <text x="45" y="27" class="label-sub" style="font-size: 9px;">ZED2</text>
  </g>

  <g transform="translate(325, 242)">
    <rect x="0" y="0" width="110" height="40" class="node-zed" style="stroke: #ea580c; fill: #fff7ed; stroke-width: 2.5;" />
    <text x="55" y="18" class="label-title" style="font-size: 11px; fill: #c2410c;">ZED3 (เซ็นเซอร์)</text>
    <text x="55" y="30" class="label-sub" style="font-size: 9px; fill: #ea580c; font-weight: bold;">โหนดผู้ส่งข้อมูล</text>
  </g>

  <g transform="translate(495, 245)">
    <rect x="0" y="0" width="90" height="35" class="node-zed" />
    <text x="45" y="17" class="label-title" style="font-size: 11px;">End Device</text>
    <text x="45" y="27" class="label-sub" style="font-size: 9px;">ZED4</text>
  </g>

  <g transform="translate(180, 298)">
    <rect x="0" y="0" width="400" height="30" class="status-banner" />
    <g class="status-lbl-normal">
      <text x="200" y="19" class="status-text">สถานะ: ปกติ | เส้นทางหลัก ZED3 → ZR2 → ZC ทำงาน</text>
      <circle cx="20" cy="15" r="5" fill="#10b981" />
    </g>
    <g class="status-lbl-fail">
      <text x="200" y="19" class="status-text" style="fill: #f87171;">คำเตือน: ZR2 ขัดข้อง! ข้อมูลถูกบล็อก</text>
      <circle cx="20" cy="15" r="5" fill="#ef4444" />
    </g>
    <g class="status-lbl-heal">
      <text x="200" y="19" class="status-text" style="fill: #fb923c;">Self-Healing: ปรับเส้นทางใหม่ → ZR3 → ZR1 → ZC</text>
      <circle cx="20" cy="15" r="5" fill="#ea580c" />
    </g>
  </g>
</svg>
</div>
...
<svg viewBox="0 0 760 280" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <style>
    .bg { fill: #0f172a; stroke: #1e293b; stroke-width: 1.5; rx: 12px; }
    .grid-line { stroke: #1e293b; stroke-width: 1; stroke-dasharray: 4 4; }
    .axis-line { stroke: #475569; stroke-width: 2; stroke-linecap: round; }
    
    .axis-label { font-size: 11px; fill: #94a3b8; font-weight: bold; }
    .title-text { font-size: 14px; fill: #f8fafc; font-weight: bold; }
    .desc-text { font-size: 11px; fill: #64748b; }
    
    .chirp-base { fill: none; stroke: #1e293b; stroke-width: 1.5; stroke-linecap: round; }
    .chirp-active { fill: none; stroke: url(#chirpGrad); stroke-width: 4; stroke-linecap: round; stroke-dasharray: 180; stroke-dashoffset: 180; }
    .chirp-glow { fill: none; stroke: #38bdf8; stroke-width: 8; stroke-linecap: round; opacity: 0.15; filter: blur(2px); stroke-dasharray: 180; stroke-dashoffset: 180; }
  ...
  <defs>
    <linearGradient id="chirpGrad" x1="0%" y1="100%" x2="100%" y2="0%">
  ...
  <path d="M 90 220 L 170 60" class="chirp-glow c1" />
  <path d="M 90 220 L 170 60" class="chirp-active c1" />

  <path d="M 170 220 L 260 60" class="chirp-glow c2" />
  <path d="M 170 220 L 260 60" class="chirp-active c2" />

  <path d="M 260 220 L 350 60" class="chirp-glow c3" />
  <path d="M 260 220 L 350 60" class="chirp-active c3" />

  <path d="M 350 220 L 440 60" class="chirp-glow c4" />
  <path d="M 350 220 L 440 60" class="chirp-active c4" />

  <path d="M 440 220 L 530 60" class="chirp-glow c5" />
  <path d="M 440 220 L 530 60" class="chirp-active c5" />

  <path d="M 530 220 L 620 60" class="chirp-glow c6" />
  <path d="M 530 220 L 620 60" class="chirp-active c6" />

  <path d="M 620 220 L 710 60" class="chirp-glow c7" />
  ...
  <polygon points="76,45 80,35 84,45" fill="#475569" />
  <polygon points="715,226 725,230 715,234" fill="#475569" />

  <text x="50" y="40" class="axis-label" text-anchor="middle" transform="rotate(-90 50 40)">ความถี่ (Frequency)</text>
  <text x="690" y="250" class="axis-label" text-anchor="middle">เวลา (Time)</text>
  
  <text x="95" y="32" class="title-text">ลักษณะสัญญาณการมอดูเลตแบบ LoRa CSS (Up-chirps)</text>
  <text x="495" y="32" class="desc-text" fill="#94a3b8">กวาดความถี่ขึ้นตามเวลา (Sweep up in frequency over time)</text>
</svg>
</div>
...
<svg viewBox="0 0 760 320" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <style>
    .bg { fill: #f8fafc; stroke: #cbd5e1; stroke-width: 1; rx: 12px; }
    .node-ed { fill: #f0fdf4; stroke: #16a34a; stroke-width: 2; rx: 6px; }
    .node-gw { fill: #fef3c7; stroke: #d97706; stroke-width: 2.5; rx: 8px; }
    .node-srv { fill: #e0e7ff; stroke: #4f46e5; stroke-width: 2.5; rx: 8px; }
    
    .label-title { font-size: 12px; font-weight: 700; fill: #0f172a; text-anchor: middle; }
    .label-sub { font-size: 10px; fill: #475569; text-anchor: middle; }
    .label-tech { font-size: 9.5px; fill: #ef4444; font-weight: bold; text-anchor: middle; }
    
    .link-wire { stroke: #cbd5e1; stroke-width: 3; stroke-linecap: round; }
    .link-wireless { stroke: #94a3b8; stroke-dasharray: 4 4; stroke-width: 1.5; }
    
    .lora-packet { fill: #ea580c; r: 5; opacity: 0; animation: sendLoRa 6s infinite ease-in-out; }
    .lora-packet-2 { fill: #ea580c; r: 5; opacity: 0; animation: sendLoRa 6s infinite ease-in-out; animation-delay: 0.2s; }
    .lora-packet-3 { fill: #ea580c; r: 5; opacity: 0; animation: sendLoRa 6s infinite ease-in-out; animation-delay: 0.4s; }
    
    .ip-packet { fill: #3b82f6; stroke: #1d4ed8; stroke-width: 1; rx: 3px; opacity: 0; }
    .ip-pack-gw-ns { width: 34px; height: 18px; animation: sendIPGwNs 6s infinite ease-in-out; }
    .ip-pack-ns-as { width: 34px; height: 18px; animation: sendIPNsAs 6s infinite ease-in-out; }
    
    .node-pulse { animation: nodeFlash 6s infinite; }
    .ns-pulse { animation: nsFlash 6s infinite; }

    @keyframes sendLoRa {
      0% { cx: 115; cy: 160; opacity: 0; }
      5% { opacity: 1; }
      25%, 100% { cx: 270; cy: 160; opacity: 0; }
    }
    @keyframes sendLoRa1 {
      0% { cx: 115; cy: 80; opacity: 0; }
      5% { opacity: 1; }
      25%, 100% { cx: 270; cy: 160; opacity: 0; }
    }
    @keyframes sendLoRa3 {
      0% { cx: 115; cy: 240; opacity: 0; }
      5% { opacity: 1; }
      25%, 100% { cx: 270; cy: 160; opacity: 0; }
    }
    ...
    @keyframes sendIPGwNs {
      0%, 33% { x: 285; y: 151; opacity: 0; }
      34% { opacity: 1; }
      54% { x: 440; y: 151; opacity: 1; }
      55%, 100% { x: 440; y: 151; opacity: 0; }
    }
    @keyframes sendIPNsAs {
      0%, 65% { x: 485; y: 151; opacity: 0; }
      66% { opacity: 1; }
      86% { x: 620; y: 151; opacity: 1; }
      87%, 100% { x: 620; y: 151; opacity: 0; }
    }
  </style>

  <rect x="5" y="5" width="750" height="310" class="bg"/>

  <text x="140" y="32" class="label-title" style="fill: #16a34a;">เครือข่ายสัญญาณวิทยุ LoRa</text>
  ...
  <text x="500" y="32" class="label-title" style="fill: #2563eb;">เครือข่าย TCP/IP / Internet</text>
  <text x="500" y="47" class="label-sub">(โครงข่ายสายเคเบิลหรือใยแก้วนำแสง)</text>

  <line x1="280" y1="160" x2="480" y2="160" class="link-wire" />
  <text x="380" y="150" class="label-tech" style="fill: #2563eb;">IP / TCP (Port 1883/8883)</text>
  
  <line x1="480" y1="160" x2="660" y2="160" class="link-wire" />
  <text x="570" y="150" class="label-tech" style="fill: #2563eb;">IP / WebSockets</text>
  ...
  <text x="160" y="105" class="label-tech" style="fill: #d97706; transform: rotate(18deg 160 105);">LoRa RF (AS923)</text>
  <text x="170" y="180" class="label-tech" style="fill: #d97706;">LoRa RF</text>
  <text x="160" y="225" class="label-tech" style="fill: #d97706; transform: rotate(-18deg 160 225);">LoRa RF</text>

  <circle class="lora-packet" style="animation-name: sendLoRa1;" />
  <circle class="lora-packet-2" />
  <circle class="lora-packet" style="animation-name: sendLoRa3; animation-delay: 0.3s;" />

  <rect class="ip-packet ip-pack-gw-ns" />
  <text x="380" y="200" class="label-sub" fill="#475569" style="font-size: 9px;">(ห่อหุ้มแพ็กเกจส่งต่ออินเทอร์เน็ต)</text>
  
  <rect class="ip-packet ip-pack-ns-as" />

  <g transform="translate(35, 55)">
    <rect x="0" y="0" width="90" height="50" class="node-ed" />
    <text x="45" y="24" class="label-title" style="fill: #15803d; font-size: 11px;">End Device</text>
    <text x="45" y="38" class="label-sub" style="font-size: 9px;">(โหนดเซ็นเซอร์ 1)</text>
    <line x1="45" y1="0" x2="45" y2="-10" stroke="#16a34a" stroke-width="2"/>
    <circle cx="45" cy="-10" r="3" fill="#16a34a"/>
  </g>

  <g transform="translate(35, 135)">
    <rect x="0" y="0" width="90" height="50" class="node-ed" />
    <text x="45" y="24" class="label-title" style="fill: #15803d; font-size: 11px;">End Device</text>
    <text x="45" y="38" class="label-sub" style="font-size: 9px;">(โหนดเซ็นเซอร์ 2)</text>
    <line x1="45" y1="0" x2="45" y2="-10" stroke="#16a34a" stroke-width="2"/>
    <circle cx="45" cy="-10" r="3" fill="#16a34a"/>
  </g>
  ...
  <g transform="translate(35, 215)">
    <rect x="0" y="0" width="90" height="50" class="node-ed" />
    <text x="45" y="24" class="label-title" style="fill: #15803d; font-size: 11px;">End Device</text>
    <text x="45" y="38" class="label-sub" style="font-size: 9px;">(โหนดเซ็นเซอร์ 3)</text>
    <line x1="45" y1="0" x2="45" y2="-10" stroke="#16a34a" stroke-width="2"/>
    <circle cx="45" cy="-10" r="3" fill="#16a34a"/>
  </g>

  <g transform="translate(230, 125)">
    <rect x="0" y="0" width="100" height="70" class="node-gw node-pulse" />
    <text x="50" y="28" class="label-title" style="fill: #b45309;">Gateway (GW)</text>
    <text x="50" y="44" class="label-sub" style="font-size: 9.5px; fill: #b45309; font-weight: bold;">เกตเวย์รับสัญญาณ</text>
    <text x="50" y="58" class="label-sub" style="font-size: 8.5px; fill: #d97706;">(แปลง RF ↔ TCP/IP)</text>
    <line x1="10" y1="0" x2="10" y2="-20" stroke="#d97706" stroke-width="3"/>
    <circle cx="10" cy="-20" r="4" fill="#d97706"/>
  </g>

  <g transform="translate(430, 125)">
    <rect x="0" y="0" width="100" height="70" class="node-srv ns-pulse" />
    <text x="50" y="28" class="label-title" style="fill: #312e81;">Network Server</text>
    <text x="50" y="44" class="label-sub" style="font-size: 9.5px; fill: #4f46e5; font-weight: bold;">เซิร์ฟเวอร์ควบคุม</text>
    <text x="50" y="58" class="label-sub" style="font-size: 8.5px; fill: #6366f1;">(คัดแยก/ถอดรหัสลับ)</text>
  </g>

  <g transform="translate(610, 125)">
    <rect x="0" y="0" width="110" height="70" class="node-srv" style="stroke: #06b6d4; fill: #ecfeff;" />
    <text x="55" y="28" class="label-title" style="fill: #0891b2;">App Server (AS)</text>
    <text x="55" y="44" class="label-sub" style="font-size: 9.5px; fill: #0891b2; font-weight: bold;">เซิร์ฟเวอร์ปลายทาง</text>
    <text x="55" y="58" class="label-sub" style="font-size: 8.5px; fill: #06b6d4;">(แดชบอร์ด/ประยุกต์ใช้งาน)</text>
  </g>
</svg>
</div>
...
<svg viewBox="0 0 760 330" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <style>
    .bg { fill: #f8fafc; stroke: #cbd5e1; stroke-width: 1; rx: 12px; }
    .tri-base { fill: #f1f5f9; stroke: #94a3b8; stroke-width: 2; stroke-linejoin: round; }
    .tri-flow { fill: none; stroke: url(#triGrad); stroke-width: 4; stroke-linecap: round; stroke-linejoin: round; stroke-dasharray: 60 500; stroke-dashoffset: 0; animation: signalRun 5s infinite linear; }
    
    .vertex-embb { fill: #ec4899; stroke: #ffffff; stroke-width: 2; animation: glowEmbb 2s infinite; }
    .vertex-urllc { fill: #f43f5e; stroke: #ffffff; stroke-width: 2; animation: glowUrllc 2s infinite; }
    .vertex-mmtc { fill: #06b6d4; stroke: #ffffff; stroke-width: 2; animation: glowMmtc 2s infinite; }
    
    .label-pillar { font-size: 14px; font-weight: 800; fill: #0f172a; }
    .label-eng { font-size: 11px; fill: #475569; font-weight: bold; }
    
    .case-box { fill: #ffffff; stroke: #e2e8f0; stroke-width: 1.5; rx: 6px; }
    .case-text { font-size: 11.5px; fill: #1e293b; font-weight: 600; }
    .b-embb { fill: #ec4899; animation: pulseBembb 1.5s infinite; }
    .b-urllc { fill: #f43f5e; animation: pulseBurllc 1.5s infinite; }
    .b-mmtc { fill: #06b6d4; animation: pulseBmmtc 1.5s infinite; }
    ...
    @keyframes glowEmbb {
      0%, 100% { r: 6; filter: drop-shadow(0 0 2px #ec4899); }
      50% { r: 10; filter: drop-shadow(0 0 8px #ec4899); }
    }
    @keyframes glowUrllc {
      0%, 100% { r: 6; filter: drop-shadow(0 0 2px #f43f5e); }
      50% { r: 10; filter: drop-shadow(0 0 8px #f43f5e); }
    }
    @keyframes glowMmtc {
      0%, 100% { r: 6; filter: drop-shadow(0 0 2px #06b6d4); }
      50% { r: 10; filter: drop-shadow(0 0 8px #06b6d4); }
    }

    @keyframes pulseBembb {
      0%, 100% { opacity: 0.4; }
      50% { opacity: 1; fill: #d01c6f; }
    }
    @keyframes pulseBurllc {
      0%, 100% { opacity: 0.4; }
      50% { opacity: 1; fill: #e11d48; }
    }
    @keyframes pulseBmmtc {
      0%, 100% { opacity: 0.4; }
      50% { opacity: 1; fill: #0891b2; }
    }
  </style>
  ...
  <text x="380" y="165" class="label-pillar" style="font-size: 15px; fill: #1e293b;" text-anchor="middle">3 เสาหลักเทคโนโลยี 5G</text>
  <text x="380" y="182" class="label-eng" style="fill: #64748b;" text-anchor="middle">(Three Pillars of 5G)</text>

  <circle cx="380" cy="65" r="8" class="vertex-embb" />
  <circle cx="220" cy="235" r="8" class="vertex-urllc" />
  <circle cx="540" cy="235" r="8" class="vertex-mmtc" />

  <g transform="translate(250, 10)">
    <text x="130" y="18" class="label-pillar" style="fill: #db2777;" text-anchor="middle">eMBB</text>
    <text x="130" y="32" class="label-eng" style="fill: #9d174d;" text-anchor="middle">(Enhanced Mobile Broadband)</text>
  </g>
  
  <g transform="translate(480, 20)">
    <rect x="0" y="0" width="250" height="60" class="case-box" style="stroke: #fbcfe8;" />
    <circle cx="15" cy="20" r="4" class="b-embb" />
    <text x="28" y="24" class="case-text">สตรีมวิดีโอ 4K/8K ความหน่วงต่ำ</text>
    <circle cx="15" cy="40" r="4" class="b-embb" />
    <text x="28" y="44" class="case-text">แอปพลิเคชัน VR/AR ในงานอุตสาหกรรม</text>
  </g>

  <g transform="translate(10, 245)">
    <text x="100" y="18" class="label-pillar" style="fill: #e11d48;" text-anchor="middle">URLLC</text>
    <text x="100" y="32" class="label-eng" style="fill: #9f1239;" text-anchor="middle">(Ultra-Reliable Low Latency)</text>
  </g>
  
  <g transform="translate(10, 160)">
    <rect x="0" y="0" width="230" height="60" class="case-box" style="stroke: #fecdd3;" />
    <circle cx="15" cy="20" r="4" class="b-urllc" />
    <text x="28" y="24" class="case-text">ควบคุมหุ่นยนต์ตอบสนองทันที (&lt;1ms)</text>
    <circle cx="15" cy="40" r="4" class="b-urllc" />
    <text x="28" y="44" class="case-text">ระบบนำทางรถยนต์อัจฉริยะ (V2X)</text>
  </g>

  <g transform="translate(550, 245)">
    <text x="100" y="18" class="label-pillar" style="fill: #0891b2;" text-anchor="middle">mMTC</text>
    <text x="100" y="32" class="label-eng" style="fill: #155e75;" text-anchor="middle">(massive Machine-Type)</text>
  </g>
  
  <g transform="translate(520, 160)">
    <rect x="0" y="0" width="230" height="60" class="case-box" style="stroke: #cffafe;" />
    <circle cx="15" cy="20" r="4" class="b-mmtc" />
    <text x="28" y="24" class="case-text">เซ็นเซอร์ความหนาแน่นสูงล้านจุด/ตร.กม.</text>
    <circle cx="15" cy="40" r="4" class="b-mmtc" />
