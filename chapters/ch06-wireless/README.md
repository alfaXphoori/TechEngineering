...
บทนี้เชื่อมโยงกับชั้น Network Layer ซึ่งรับผิดชอบการส่งข้อมูลจากอุปกรณ์ปลายทางไปยังระบบประมวลผลและคลาวด์
...
<svg viewBox="0 0 760 450" width="100%" height="auto" role="img" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- คำบรรยายแผนภาพ -->
  <text x="380" y="432" class="footer-text" text-anchor="middle">แผนภาพที่ 6.1 สถาปัตยกรรม IoT 4 ชั้น แสดงการไหลของข้อมูลสองทิศทาง (Bi-directional Data Flow)</text>
</svg>
</div>
...
### 6.2.4 ความปลอดภัย WPA3 และ MU-MIMO
...
### 6.2.5 โหมดการประหยัดพลังงาน Wi-Fi ของ ESP32
...
### 6.2.6 การกำหนดค่า IP: DHCP vs Static IP
...
### 6.2.7 แนวคิดพอร์ต TCP (TCP Ports)
...
### 6.2.8 ตัวอย่างโค้ด ESP32 Wi-Fi (Non-blocking & Static IP / DHCP Web Server)
...
### 6.3.2 BLE 5.0 — ฟีเจอร์ที่ปรับปรุงสำคัญ
...
### 6.3.3 สถาปัตยกรรม GATT (Generic Attribute Profile)
...
### 6.3.4 กระบวนการสื่อสาร: Advertising vs Connection
...
### 6.3.5 ตัวอย่างโค้ด ESP32 BLE GATT Server
...
### 6.5.2 สมการ Link Budget และ Spreading Factor vs. Data Rate
...
### 6.5.3 สถาปัตยกรรมเครือข่าย LoRaWAN (Star-of-Stars)
...
### 6.5.4 ประเภทการทำงาน Class A / B / C
...
### 6.5.5 Duty Cycle และ Fair Access Policy
...
### 6.6.4 5G NR Numerology (µ) และ Network Slicing
...
## 6.7 ตารางเปรียบเทียบเชิงวิศวกรรม 6 เทคโนโลยีไร้สาย
...
## 6.8 กรณีศึกษาทางวิศวกรรม (Engineering Case Studies)
...
## 6.9 เกณฑ์การเลือกเทคโนโลยีวิศวกรรมไร้สาย

### 6.9.1 ปัจจัยสำคัญ (Key Design Factors)
...
**ข้อ 6:** เครือข่าย Mesh Zigbee มีกลไกอย่างไรในการจัดส่งข้อมูลหากเส้นทางปกติเสียหาย (Self-Healing) และ Coordinator มีบทบาทอย่างไรเมื่อมีอุปกรณ์ใหม่เข้าร่วมเครือข่าย

**ข้อ 7:** จงวิเคราะห์เปรียบเทียบ LoRaWAN Class A, B, C สำหรับระบบควบคุมวาล์วดับเพลิงฉุกเฉินในโรงงานปิโตรเคมี พร้อมแสดงข้อดีข้อจำกัดของ Class A และแนะนำการคำนวณ Link Budget

**ข้อ 8:** โรงงานปูนซีเมนต์ต้องการวัดอุณหภูมิและความชื้นของเตาเผาทรงกระบอกหมุนยาว 150 เมตร จงเลือกเทคโนโลยีไร้สายที่เหมาะสมระหว่าง Wi-Fi, BLE และ LoRa พร้อมวิเคราะห์เหตุผลเชิงวิศวกรรม

**ข้อ 9:** จงอธิบายความแตกต่างที่สำคัญในเรื่อง Mobility Support/Handover ระหว่าง NB-IoT และ LTE-M ในการประยุกต์ใช้ติดตามรถบรรทุกขนส่งสินค้าทั่วประเทศ

**ข้อ 10:** จงอธิบายแนวคิด 5G Network Slicing และ NR Numerology (µ) ว่ามีความสัมพันธ์กันอย่างไรในการรองรับ URLLC สำหรับระบบควบคุมหุ่นยนต์แขนกลในโรงงาน โดยยกตัวอย่างค่า µ ที่เหมาะสมและอธิบายเหตุผลทางวิศวกรรม
