...
บทนี้เชื่อมโยงกับชั้น Processing / Cloud Layer ซึ่งรวบรวม จัดเก็บ และประมวลผลข้อมูลจากอุปกรณ์ IoT
...
<svg viewBox="0 0 760 450" width="100%" height="auto" role="img" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- คำบรรยายแผนภาพ -->
  <text x="380" y="432" class="footer-text" text-anchor="middle">แผนภาพที่ 8.1 สถาปัตยกรรม IoT 4 ชั้น แสดงการไหลของข้อมูลสองทิศทาง (Bi-directional Data Flow)</text>
</svg>
</div>
