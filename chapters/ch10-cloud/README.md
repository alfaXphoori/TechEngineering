# Chapter 9: เทคโนโลยีคลาวด์และแพลตฟอร์ม IoT
...
### 9.1.1 ประโยชน์ของ Cloud Computing สำหรับ IoT ในงานวิศวกรรม
...
### 9.1.2 การเปรียบเทียบและการตัดสินใจเลือกระหว่าง Edge Computing และ Cloud Computing (Edge vs. Cloud Trade-offs)
...
### 9.1.3 ตัวชี้วัดประสิทธิภาพระบบเครือข่ายสำหรับวิศวกร (Network QoS Metrics)
...
### 9.1.4 การลดความละเอียดและการดึงคุณลักษณะเด่นของข้อมูลที่ขอบ (Data Downsampling & Feature Extraction)
...
## 9.2 รูปแบบบริการ IaaS/PaaS/SaaS
...
## 9.3 รูปแบบการติดตั้ง Public/Private/Hybrid
...
### 9.4.1 สถาปัตยกรรมท่อส่งข้อมูลการวัดคลาวด์ในอุตสาหกรรม (Industrial Telemetry Pipeline)
...
### 9.4.2 แนวคิด Digital Twin (Device Shadow)
...
### 9.6.1 กุญแจยืนยันตัวตน (Authentication Token) และแนวปฏิบัติความปลอดภัย
...
### 9.6.2 ข้อมูลโทรมาตร (Telemetry) และคำสั่งควบคุมระยะไกล (RPC)
...
### 9.6.3 การจัดการการเชื่อมต่อแบบ Blocking vs Non-blocking
...
### 9.6.4 ทำไมคำสั่ง `delay()` เป็นอันตรายในงาน IoT และซอฟต์แวร์ไทม์เมอร์แบบ Non-blocking
...
### 9.6.5 การควบคุมอัตราการส่งข้อมูลและ Flood Error (Rate Limiting)
...
### 9.6.6 ตัวอย่างโค้ด: การส่งข้อมูลเซนเซอร์ผ่าน ESP32 ขึ้นสู่ ThingsBoard Cloud
...
## 9.7 ฐานข้อมูล time-series และการจัดเก็บข้อมูลเซนเซอร์
...
### 9.7.1 ความแตกต่างระหว่างฐานข้อมูลแบบดั้งเดิม (SQL) และ Time-series Database (TSDB)
...
### 9.7.2 โครงสร้างและแนวคิดสำคัญของ InfluxDB (InfluxDB Core Concepts)
...
## 9.8 กรณีศึกษาเชิงวิศวกรรมเครื่องกล (Mechanical/Industrial Case Studies)

เพื่อเชื่อมโยงความรู้สู่การใช้งานจริงในโรงงานอุตสาหกรรม นักศึกษาควรศึกษา 3 กรณีศึกษาต้นแบบต่อไปนี้:

### 9.8.1 กรณีศึกษาที่ 1: ระบบตรวจติดตามความปลอดภัยของหม้อไอน้ำอุตสาหกรรม (Steam Boiler Safety Monitoring)
...
### 9.8.2 กรณีศึกษาที่ 2: ระบบตรวจสอบและวิเคราะห์การสั่นสะเทือนของแบริ่งมอเตอร์ขับในโรงงาน (CNC Spindle Bearing Monitoring)
...
### 9.8.3 กรณีศึกษาที่ 3: ระบบตรวจติดตามการรั่วไหลและการประหยัดพลังงานในระบบลมอัด (Pneumatic System Air Leak Detection)
...
## 9.9 ความปลอดภัยและความเป็นส่วนตัวเบื้องต้นของระบบ IoT
