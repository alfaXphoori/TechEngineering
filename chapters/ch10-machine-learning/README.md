...
<svg viewBox="0 0 820 380" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <style>
    ...
    .box { fill: #ffffff; stroke-width: 2; rx: 10px; filter: drop-shadow(0px 4px 6px rgba(0, 0, 0, 0.05)); }
    .box-cloud { stroke: #2563eb; }
    .box-opt { stroke: #7c3aed; }
    .box-edge { stroke: #10b981; }
    .conn-line { fill: none; stroke: #94a3b8; stroke-width: 3; stroke-dasharray: 8 8; }
    ...
    .label-g { fill: #10b981; font-weight: 700; }
    .node-active { fill: #7c3aed; stroke: #ffffff; stroke-width: 1.5; animation: pulseNode 2s infinite alternate; }
    .node-pruned { fill: #e2e8f0; stroke: #cbd5e1; stroke-width: 1.5; stroke-dasharray: 2 2; }
    .net-link { stroke: #e2e8f0; stroke-width: 1.5; }
    .net-link-active { stroke: #c084fc; stroke-width: 1.5; }
    @keyframes flowDash1 {
  ...
  <!-- Title -->
  <text x="410" y="42" font-size="16" font-weight="700" fill="#0f172a" text-anchor="middle">ภาพที่ 10.1: กระบวนการพัฒนาและบีบอัดโมเดล TinyML (Pipeline)</text>
  
  <!-- 1. Cloud Block -->
  <rect x="40" y="80" width="200" height="230" class="box box-cloud"/>
  <path d="M 140 120 C 130 120, 125 125, 120 130 C 110 125, 95 130, 95 145 C 95 155, 105 165, 120 165 L 160 165 C 175 165, 185 155, 185 145 C 185 135, 175 125, 165 120 C 165 110, 150 110, 140 120 Z" fill="#eff6ff" stroke="#3b82f6" stroke-width="2"/>
  ...
  <text x="140" y="300" class="text-code" fill="#2563eb" text-anchor="middle">ขนาดโมเดล: ~10MB - 100MB</text>
  ...
  <rect x="320" y="80" width="220" height="230" class="box box-opt"/>
  ...
  <line x1="360" y1="130" x2="410" y2="145" class="net-line" stroke-dasharray="2 2" stroke="#cbd5e1"/>
  ...
  <!-- 3. Edge MCU Block -->
  <rect x="590" y="80" width="190" height="230" class="box box-edge"/>
  <!-- MCU representation -->
  <rect x="655" y="120" width="60" height="50" fill="#f0fdf4" stroke="#10b981" stroke-width="2" rx="4"/>
  <!-- MCU pins -->
  <line x1="655" y1="130" x2="648" y2="130" stroke="#10b981" stroke-width="2"/>
  <line x1="655" y1="140" x2="648" y2="140" stroke="#10b981" stroke-width="2"/>
  <line x1="655" y1="150" x2="648" y2="150" stroke="#10b981" stroke-width="2"/>
  <line x1="655" y1="160" x2="648" y2="160" stroke="#10b981" stroke-width="2"/>
  <line x1="715" y1="130" x2="722" y2="130" stroke="#10b981" stroke-width="2"/>
  <line x1="715" y1="140" x2="722" y2="140" stroke="#10b981" stroke-width="2"/>
  <line x1="715" y1="150" x2="722" y2="150" stroke="#10b981" stroke-width="2"/>
  <line x1="715" y1="160" x2="722" y2="160" stroke="#10b981" stroke-width="2"/>
  <text x="685" y="148" font-size="10" font-weight="700" fill="#047857" text-anchor="middle">ESP32</text>
  ...
  <text x="685" y="238" class="text-code" fill="#059669" text-anchor="middle">Precision: Int8</text>
  ...
  <text x="685" y="300" class="text-code" fill="#059669" text-anchor="middle">ขนาดโมเดล: &lt; 100KB</text>
</svg>
...
<svg viewBox="0 0 820 340" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" font-family="'IBM Plex Sans Thai', system-ui, sans-serif">
  ...
  <style>
    ...
    @keyframes normalBoxActive {
      0%, 50% { fill: #f0fdf4; stroke: #4ade80; stroke-width: 2.5; filter: drop-shadow(0 0 4px #bbf7d0); }
      50.01%, 100% { fill: #ffffff; stroke: #e2e8f0; stroke-width: 1.5; filter: none; }
    }
    @keyframes anomalyBoxActive {
      0%, 50% { fill: #ffffff; stroke: #e2e8f0; stroke-width: 1.5; filter: none; }
      50.01%, 100% { fill: #fef2f2; stroke: #f87171; stroke-width: 2.5; filter: drop-shadow(0 0 4px #fecaca); }
    }
    ...
    @keyframes lampNormalActive {
      0%, 50% { fill: #10b981; filter: drop-shadow(0 0 8px #10b981); }
      50.01%, 100% { fill: #cbd5e1; filter: none; }
    }
    @keyframes lampAnomalyActive {
      0%, 50% { fill: #cbd5e1; filter: none; }
      50.01%, 100% { fill: #ef4444; filter: drop-shadow(0 0 10px #ef4444); }
    }
    ...
    @keyframes connNormalActive {
      0%, 50% { stroke: #10b981; stroke-width: 3; filter: drop-shadow(0 0 2px #10b981); }
      50.01%, 100% { stroke: #e2e8f0; stroke-width: 1.5; filter: none; }
    }
    @keyframes connAnomalyActive {
      0%, 50% { stroke: #e2e8f0; stroke-width: 1.5; filter: none; }
      50.01%, 100% { stroke: #ef4444; stroke-width: 3; filter: drop-shadow(0 0 2px #ef4444); }
    }
    ...
    /* Text colors dynamic */
    .label-g { fill: #059669; font-weight: bold; }
    .label-r { fill: #dc2626; font-weight: bold; }
  </style>
  <rect x="5" y="5" width="810" height="330" class="bg"/>
  
  <!-- Title -->
  <text x="410" y="42" font-size="16" font-weight="700" fill="#0f172a" text-anchor="middle">ภาพที่ 10.2: การวิเคราะห์สัญญาณและตรวจจับความผิดปกติแบบเรียลไทม์บนชิป</text>
  
  <!-- Panel 1: Input Sensor -->
  <rect x="35" y="80" width="220" height="150" rx="8" fill="#0f172a" stroke="#475569" stroke-width="2"/>
  ...
  <rect x="300" y="80" width="220" height="150" rx="8" fill="#ffffff" stroke="#7c3aed" stroke-width="2"/>
  ...
  <!-- Outputs -->
  <circle cx="485" cy="135" r="4.5" fill="#10b981"/>
  <circle cx="485" cy="175" r="4.5" fill="#ef4444"/>
  
  <!-- Lines -->
  <line x1="335" y1="135" x2="410" y2="120" stroke="#e2e8f0" stroke-width="1.5"/>
  <line x1="335" y1="135" x2="410" y2="155" stroke="#e2e8f0" stroke-width="1.5"/>
  <line x1="335" y1="175" x2="410" y2="155" stroke="#e2e8f0" stroke-width="1.5"/>
  <line x1="335" y1="175" x2="410" y2="190" stroke="#e2e8f0" stroke-width="1.5"/>
  
  <line x1="410" y1="120" x2="485" y2="135" stroke="#e2e8f0" stroke-width="1.5"/>
  <line x1="410" y1="155" x2="485" y2="135" stroke="#e2e8f0" stroke-width="1.5"/>
  <line x1="410" y1="155" x2="485" y2="175" stroke="#e2e8f0" stroke-width="1.5"/>
  <line x1="410" y1="190" x2="485" y2="175" stroke="#e2e8f0" stroke-width="1.5"/>
  ...
  <g transform="translate(0, 0)">
    <rect x="560" y="80" width="220" height="65" rx="8" class="box-normal-bg"/>
  ...
  <!-- Anomaly Result Box -->
  <g transform="translate(0, 0)">
    <rect x="560" y="165" width="220" height="65" rx="8" class="box-anomaly-bg"/>
