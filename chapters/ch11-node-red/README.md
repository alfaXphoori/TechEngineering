# Chapter 10: ระบบฐานข้อมูลและแดชบอร์ดแสดงผลท้องถิ่น (Local Databases & Node-RED Orchestration)
...
## 10.2 ระบบฐานข้อมูลสำหรับข้อมูลเชิงอนุกรมเวลา (Databases for Time-Series IoT Data)
...
### 10.2.1 ฐานข้อมูลอนุกรมเวลา (Time-Series Database: TSDB)
...
### 10.2.2 ฐานข้อมูลเชิงสัมพันธ์น้ำหนักเบา (Relational Database: SQLite)
...
### 10.3.1 ตัวอย่างการสร้างโฟลว์ใน Node-RED เพื่อบันทึกข้อมูลและแสดงผล
