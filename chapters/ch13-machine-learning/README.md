# Chapter 12: การเรียนรู้ของเครื่องเบื้องต้นสำหรับ IoT
...
## 12.1 ML คืออะไร และเทียบกับการเขียนกฎแบบดั้งเดิม
...
## 12.2 ประเภทการเรียนรู้ (Types of Learning)
...
## 12.3 ขั้นตอนการพัฒนาโมเดล (ML Pipeline)
...
## 12.4 ฟีเจอร์จากข้อมูลเซนเซอร์ (Feature Engineering)
...
## 12.5 ตัวอย่างอัลกอริทึมเบื้องต้น
...
## 12.6 TinyML และ Edge AI (TinyML and Edge AI)
...
### 12.6.1 เทคนิคการเพิ่มประสิทธิภาพโมเดลสำหรับ TinyML (Model Optimization Techniques)
...
### 12.6.2 กระบวนการทำงานของ Edge Impulse (Edge Impulse Pipeline)
...
### 12.6.3 โค้ดตัวอย่างการตรวจจับความผิดปกติ (Local Anomaly Detection on ESP32)
...
## 12.8 ตัวอย่างโค้ด Python บน Google Colab
